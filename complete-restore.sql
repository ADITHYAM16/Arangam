...
-- Update all 'approved' status to 'booked'
UPDATE bookings SET status = 'booked' WHERE status = 'approved';
UPDATE mg_auditorium_bookings SET status = 'booked' WHERE status = 'approved';
